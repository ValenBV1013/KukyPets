...
<div class="wrapper">
	<div class="sidebar" data-background-color="white" data-active-color="danger">
		...
		<nav class="navbar navbar-default">
           ...
           $sql="select * from historial_mascota";
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Historial mascota</h4><br>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $filas ['id_historial'] ?></td>
                                            <td><?php echo $filas ['id_mascota'] ?></td>
                                            <td><?php echo $filas ['fecha'] ?></td>
                                            <td><?php echo $filas ['notas'] ?></td>
                                            <td>
                                                <?php echo "<a href = '../eliminar/eliminar_historial_mascota.php?id_historial=".$filas['id_historial']."'>ELIMINAR</a>"; ?>
