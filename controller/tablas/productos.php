            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Productos</h4><br>
                                    ...
                                    <thead>
                                     ...
                                     <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $filas ['stock_actual'] ?></td>
                                            <td><?php echo $filas ['categoria'] ?></td>
                                            <td>
                                                <?php echo "<a href = '../eliminar/eliminar_productos.php?id_producto=".$filas['id_producto']."'>ELIMINAR</a>"; ?>
