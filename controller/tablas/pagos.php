                                ...
                                <table class="table table-striped">
                                    <thead>
                                     ...
                                     <?php 
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $filas ['id_pago'] ?></td>
                                            <td><?php echo $filas ['id_cita'] ?></td>
                                            <td><?php echo $filas ['monto'] ?></td>
                                            <td><?php echo $filas ['metodo_pago'] ?></td>
                                            <td><?php echo $filas ['fecha_pago'] ?></td>
                                            <td><?php echo $filas ['comprobante_id'] ?></td>
                                            <td><?php echo $filas ['archivo_png'] ?></td>
                                            <td>
                                                <?php echo "<a href = '../eliminar/eliminar_cita.php?id_pago=".$filas['id_pago']."'>ELIMINAR</a>"; ?>
