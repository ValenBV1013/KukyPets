            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Inventario movimientos</h4><br>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $filas ['id_movimiento'] ?></td>
                                            ...
                                            <td>
                                                <?php echo "<a href = '../eliminar/eliminar_inventario_movimientos.php?id_movimiento=".$filas['id_movimiento']."'>ELIMINAR</a>"; ?>
