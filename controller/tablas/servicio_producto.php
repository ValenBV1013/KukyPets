...
<div class="wrapper">
	<div class="sidebar" data-background-color="white" data-active-color="danger">
		...
		<nav class="navbar navbar-default">
           ...
           $sql="select * from servicio_producto";
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Servicio_producto</h4><br>

                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    <thead>
                                    	<th>id_servicio_producto</th>
                                    	<th>id_servicio</th>
                                    	<th>id_producto</th>
                                    	<th>cantidad</th>
                                        <th>Acciones</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $filas ['id_servicio_producto'] ?></td>
                                            <td><?php echo $filas ['id_servicio'] ?></td>
                                            <td><?php echo $filas ['id_producto'] ?></td>
                                            <td><?php echo $filas ['cantidad'] ?></td>
                                            <td>
                                                <?php echo "<a href = '../eliminar/eliminar_servicio_producto.php?id_servicio_producto=".$filas['id_servicio_producto']."'>ELIMINAR</a>"; ?>
